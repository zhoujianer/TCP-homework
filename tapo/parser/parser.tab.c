...
{
       0,     0,     3,     4,     7,    14,    16,    20,    24,    26
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      23,     0,    -1,    -1,    23,    24,    -1,     3,    25,     4,
       6,     5,     8,    -1,    26,    -1,    25,    11,    26,    -1,
      27,    10,    27,    -1,     7,    -1,    27,     9,    27,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    41,    41,    43,    47,    63,    64,    69,    73,    74
};
#endif
...
{
  "$end", "error", "$undefined", "CONDITION", "TYPE", "DETAIL",
  "ENUMERATION", "IDENTIFIER", "STRING", "CALOP", "CMPOP", "LOGOP", "'>'",
  "'<'", "NE", "EQ", "LE", "GE", "'+'", "'-'", "'*'", "'/'", "$accept",
  "program", "block", "condition", "cmpexpr", "expr", 0
};
#endif
...
{
       9,     2,    11,    12,     3,    15,    16,    10,    17,     5,
      13,     0,     0,     0,    11,    18,    14
};

static const yytype_int8 yycheck[] =
{
       4,     0,     9,    10,     3,    11,    12,    11,     5,     7,
       6,    -1,    -1,    -1,     9,     8,    10
};
...
{
       0,    23,     0,     3,    24,     7,    25,    26,    27,     4,
      11,     9,    10,     6,    26,    27,    27,     5,     8
};
...
#line 48 "parser.y"
    { 
		char buff[2048];
		sprintf(buff, "\tif (%s)\n\t\treturn %s;\n", (yyvsp[(2) - (6)].sval), (yyvsp[(4) - (6)].sval));
		append_to_string(&body, buff);
		sprintf(buff, "%s, ", (yyvsp[(4) - (6)].sval));
...
/* Line 1455 of yacc.c  */
#line 64 "parser.y"
    { (yyval.sval) = print_string("(%s %s %s)", (yyvsp[(1) - (3)].sval), (yyvsp[(2) - (3)].sval), (yyvsp[(3) - (3)].sval), NULL); ;}
    break;
